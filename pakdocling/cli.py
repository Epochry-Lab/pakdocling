...
app = typer.Typer(
    name="pakdocling",
    help="Pakistani Document Intelligence Library - Structured Data Extraction CLI",
...
def extract(
    ...
    """Extract structured data from a Pakistani document image."""
    console.print(f"[bold blue]Processing document:[/bold blue] {image_path}")
    ...
    try:
        ...
        json_data = result.model_dump_json(indent=2 if pretty else None)
